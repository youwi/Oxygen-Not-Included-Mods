...
namespace MiniBase
{
  class MiniBaseUtils
  {
    public static bool IsMiniBase()
    {
      ...
      bool outFlag= clName == "clusters/" + ClusterName || clName == "expansion1::clusters/" + ClusterName
        ||clName== ("expansion1::clusters/"+ ClusterName + "DLC");
      Console.WriteLine("IsMiniBase: " + clName+" ->"+ outFlag);
      return outFlag;
    }
